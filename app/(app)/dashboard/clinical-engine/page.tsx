...
export const metadata: Metadata = {
  ...
  description: "Live AIWIZN clinical-engine scenario demo, available to authenticated members.",
...
export default function ClinicalEnginePage() {
  return (
    <div className="-mx-5 -my-12 md:-mx-8 lg:-mx-12">
      ...
      <p className="border-t border-ink/10 bg-cream-light/40 px-5 py-3 font-mono text-[10px] uppercase tracking-label text-ink-3 md:px-8 lg:px-12">
        Embedded from thomas-aten.github.io/aiwizn-clinical-engine · Confidential
      </p>
    </div>
  );
}
