...
// Hidden, share-by-link only. Not surfaced in nav, footer, or sitemaps.
// Indexers are told to skip, and robots.txt disallows the /private/ branch.

export const metadata: Metadata = {
  title: "Investor brief",
  description:
    "AIWIZN — $2.0M Seed · 18-month runway to Series A. Private investor brief.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
    ...
    <>
      <section>
        <div className="container pt-20 pb-4 md:pt-28">
          <p className="label">Private · Investor brief</p>
